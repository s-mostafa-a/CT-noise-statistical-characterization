...
def _compute_next_gamma(y, theta, big_jay):
    ...
    gamma_numerators = np.empty(shape=shape_of_gamma, dtype=float)
...
def run_first_log_algorithm(y: np.array, mu: np.array, neighborhood_size=0, delta=-1030, max_iter=5, tol=0.01,
