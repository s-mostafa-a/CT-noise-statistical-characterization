...
theta_1, gamma_1 = run_first_algorithms(y=X_1, centered_mu=MU, non_central=True)
print(theta_1)
#################################
# running the second algorithm
img = np.load(f'''./resources/2d_img.npy''')
X_2 = img
theta_2, gamma_2 = run_first_algorithms(y=X_2, centered_mu=MU, non_central=True, max_iter=10)
print(theta_2)
